  ...
  render () {
    return (
      <Nav defaultActiveKey="/" className={styles.sidebar}>
        ...
        <Nav.Link href="#players" eventKey="players" className={styles.navLink}>
        ...
        <NavDropdown title="曲目列表" id="nav-dropdown" className={styles.offsetLeft}>
          <NavDropdown.Item href="#music/1" eventKey="music-1">Faded</NavDropdown.Item>
          <NavDropdown.Item href="#music/2" eventKey="music-2">Whatever it takes</NavDropdown.Item>
        </NavDropdown>
